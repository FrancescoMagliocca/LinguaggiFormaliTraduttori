...
public class Lexer {
	...
	//assumo che un id valido sia generato dalla seguente esp.reg: [a-zA-Z][a-zA-Z0-9]*
    ...
    public Token lexical_scan(BufferedReader br) {// legge il token
        ...
        switch (peek) {
            ...
            default:
                if (Character.isLetter(peek)) {//se il carattere è una lettera,creo la parola e la salvo in "id" e controllo quale operatore è
                    String id = "";
