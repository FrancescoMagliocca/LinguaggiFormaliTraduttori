...
public class Lexer {
    ...
    //assumo che una costante valida sia generata dalla seguente esp.reg: 0|[1-9][0-9]*
    ...
    private boolean isValidId(String s){
        boolean valid=false;
        int currentIndex=0;
        if(Character.isLetter(s.charAt(currentIndex)) || s.charAt(currentIndex)=='_'){/*2.2*/
            currentIndex++;
            valid = true;
    ...
    public Token lexical_scan(BufferedReader br) {
        ...
        switch (peek) {
            ...
            default:
                if (Character.isLetter(peek) || peek == '_') {/*2.2*/        
                    String id = "";
                    while (Character.isDigit(peek)||Character.isLetter(peek)||peek=='_'){
                        id+=peek;//costruisco la parola
                        readch(br);
                    }
                    switch (id){
                        case "cond":
